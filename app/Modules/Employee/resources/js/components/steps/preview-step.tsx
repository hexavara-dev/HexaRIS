import { toUploadedFile, type SelectFieldOption } from '@/components/form/form-field';
...
function DocumentRow({ label, file }: { label: string; file: File | null }) {
    ...
    return (
        <div className="flex w-full items-center gap-4 rounded-lg border border-[#E7E7E7] bg-white px-4 py-2">
